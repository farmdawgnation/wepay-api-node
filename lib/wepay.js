...
var WePay = (function() {
  /**
   * The release number of wepay-api-node, for internal use.
  **/
  var release = "0.1.0-snapshot";
  ...
  **/
  var user_agent = "wepay-api-node/" + release;
  ...
  **/
  ...
  if (! release_final) {
   console.error("[wepay-api] WARNING: The copy of wepay-node you're using is experimental.");
   console.error("[wepay-api] It may be broken or behave very unexpectedly. Don't use it in production.");
  }
